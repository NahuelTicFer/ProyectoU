<?php
// edit_users.php - Página para listar y editar usuarios (solo accesible por administradores)
...
$usuarios = [];
$sql = "SELECT u.IDUsuario, u.Nombre, u.ApellidoPaterno, u.ApellidoMaterno, u.Correo, r.NombreRol, u.Activo 
        FROM Usuarios u 
...
<head>
    ...
    <title>Editar Usuarios - Sistema de Gestión de Archivos MI TELEFÉRICO</title>
    <!-- Estilos CSS -->
    <style>
        * {
            margin: 0;
        ...
        .users-table tr.active-row {
            background: rgba(0, 255, 0, 0.1); /* Verde claro para activo */
        }

        .users-table tr.inactive-row {
            background: rgba(255, 0, 0, 0.1); /* Rojo claro para inactivo */
        }
            ...
            <table class="users-table" id="usersTable">
                ...
                <tbody>
                    <?php foreach ($usuarios as $usuario): ?>
                        <tr class="<?php echo $usuario['Activo'] ? 'active-row' : 'inactive-row'; ?>">
