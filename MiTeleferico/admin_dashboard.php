<?php
// admin_dashboard.php - Dashboard principal para administradores
...
// Inclusión de conexión a la base de datos (opcional aquí, pero listo para futuras expansiones)
include 'Conn.php';

// Cerrar conexión si no se usa
$conn->close();
?>
...
<head>
    ...
    <title>Dashboard Administrador - Sistema de Gestión de Archivos MI TELEFÉRICO</title>
    <!-- Estilos CSS -->
    <style>
        * {
            margin: 0;
...
<body>
    <div class="dashboard-container">
        ...
        <main>
            ...
            <p>Utilice el menú superior para gestionar usuarios, documentos, reportes y más en el sistema MI TELEFÉRICO - CRM.</p>
        </main>
    </div>

    <!-- Script JS para mejoras opcionales (no necesario para dropdowns CSS puros) -->
    <script>
        // Si se necesita JS adicional, agregar aquí
    </script>
</body>
</html>