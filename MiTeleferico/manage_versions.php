<?php
// manage_versions.php - Página para gestionar versiones de documentos (solo accesible por administradores)
...
// Consulta base para documentos con sus versiones
$documentos = [];
...
$sql .= " ORDER BY d.Nombre_Documento ASC, v.NumeroVersion DESC";
...
<head>
    ...
    <title>Gestionar Versiones - Sistema de Gestión de Archivos MI TELEFÉRICO</title>
    <!-- Estilos CSS -->
    <style>
        * {
            margin: 0;
                ...
                <tbody>
                    <?php foreach ($documentos as $doc): ?>
                        <tr>
                            ...
                            <td><a href="#" class="action-btn" onclick="alert('Detalles de la versión <?php echo htmlspecialchars($doc['NumeroVersion']); ?> del documento <?php echo addslashes(htmlspecialchars($doc['Nombre_Documento'])); ?>')">ℹ️</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
